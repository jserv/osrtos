...
slug: cgui
version: 2.0.5
codeUrl: https://sourceforge.net/projects/cgui/
siteUrl: http://cgui.sourceforge.net/
date: '2016-12-01'
lastUpdated: '2008-06-15'
star: 0
licenses:
- GPL
summary: CGUI is a library that provides you with a set of C-functions to create GUI
  applications, i.e. windows and window controls like buttons, check-boxes, menus,
  input boxes etc.
libraryType: gui
---
